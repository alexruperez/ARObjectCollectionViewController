...
@interface ARModalWebViewController ()

@property (nonatomic, strong) ARWebViewController *webViewController;

@end


@implementation ARModalWebViewController
